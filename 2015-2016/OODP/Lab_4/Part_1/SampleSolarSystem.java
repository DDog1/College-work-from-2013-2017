...
public class SampleSolarSystem extends JFrame{
	...
	public static void main(String[] args) {
		...
		try {
			...
			JOptionPane.showMessageDialog(solarSystem, "Sorry Only One Sun Can be Included In the Solar System","Solar System Error",JOptionPane.ERROR_MESSAGE);
		}
