...
public class wealthBuilder extends JxFrame
  implements ListSelectionListener, ActionListener {
    ...
    private Vector JapaneseS;   //list of japanese
    ...
    private void stockList_Click() {
        ...
        //this is for the japanese stocks
        case 3:
        	v = JapaneseS;
        }
    ...
    private void buildStockLists() {
        ...
        //creating the vector fot the japanese stocks
        JapaneseS = new Vector();
        //adding the elements in the radio button
        JapaneseS.addElement("Computers");
        JapaneseS.addElement("Laptops");
        JapaneseS.addElement("Desktops");
        JapaneseS.addElement("Hardware");
        JapaneseS.addElement("Software");
