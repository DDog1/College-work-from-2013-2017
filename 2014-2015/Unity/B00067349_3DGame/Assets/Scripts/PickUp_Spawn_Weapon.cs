...
public class PickUp_Spawn_Weapon : MonoBehaviour {
	
	public Rigidbody weapon;
	public float numberOfWeapon;
	public float nextWeaponTime;
	...
	IEnumerator Spawn()
	{
		...
		while(true)
		{
			...
			// after it spawns the weapon, it waits to start the next wave
